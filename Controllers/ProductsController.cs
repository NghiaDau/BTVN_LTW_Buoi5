...
namespace BTVN5.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["CategpryId"] = new SelectList(_context.Categories, "Id", "CategortName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Price,Description,Image,CategpryId")] Product product)
        {
            ...
            ViewData["CategpryId"] = new SelectList(_context.Categories, "Id", "CategortName", product.CategpryId);
            return View(product);
        }
